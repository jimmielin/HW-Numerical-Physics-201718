...
def solveAllBisection(f, df, a, b, distance, partitions, maxE = 1e-5):
    ...
    from multiprocessing import pool
    MPool = pool.Pool(8)
    rs = MPool.map(_hermite_solve_mpCaller_24_bis_1em1, xs)
...
if __name__ == '__main__':
    ...
    print(solveAllBisection(lambda x: HermitePoly(24, x, True), None, ArbitraryPrecision(1, -6, InternalAware = True), ArbitraryPrecision(7), 0.1, 70))
